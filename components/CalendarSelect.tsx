...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, X, ChevronDown, Sun, ArrowRight, ChevronsRight } from 'lucide-react';
        ...
        {showShortcuts && (
          <>
            <button 
               ...
               className="bg-stone-50 hover:bg-stone-100 p-2 rounded-lg text-stone-500 hover:text-ink transition-colors"
               title="Tomorrow"
            >
               <Sun size={18} />
            </button>
                    ...
                    {Array.from({ length: 12 }, (_, i) => i).map((m) => (
                      <button
                        ...
                        className={`p-2 rounded-lg text-sm font-medium transition-colors ${
                          viewDate.getMonth() === m && viewDate.getFullYear() === pickerYear
                            ? 'bg-ink text-white'

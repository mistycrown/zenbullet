...
import { X, Repeat, Trash2, Square, Circle, Minus, CheckSquare, XSquare, PanelRightClose, SkipForward, Ban, AlertCircle, Palette } from 'lucide-react';
             ...
             <div className="flex gap-2">
               {[
                 ...
                 <button
                   ...
                   className={`flex-1 py-1.5 rounded-md flex items-center justify-center gap-1.5 text-xs font-medium border transition-colors ${
                     entry.status === opt.val 
              ...
              <div className="flex gap-1 bg-stone-50 p-1 rounded-lg border border-stone-200">
                {(['task', 'event', 'note'] as EntryType[]).map((t) => (
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded flex items-center justify-center text-xs font-medium transition-colors ${
                      entry.type === t 

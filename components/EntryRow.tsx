...
const EntryRow: React.FC<EntryRowProps> = ({ 
  ...
  return (
    <div 
      ...
      className={`group flex items-start gap-3 rounded-xl transition-all duration-200 cursor-pointer border relative ${
        compact ? 'p-2 mb-1 text-sm items-center' : 'p-3 mb-2'
      } ${
        isSelected 
      ...
      <div className="flex-1 min-w-0">
        ...
        {!compact && (
          <div className="flex items-center gap-2 mt-1.5 flex-wrap min-h-[20px]">
            ...
            {entry.type === 'event' && (
              <span className="text-xs text-stone-400 font-hand">10:00 AM</span>
            )}
